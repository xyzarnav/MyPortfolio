  ...
  const education = [
    {
      ...
      period: "2021 - 2025",
      location: "India",
      description: "Focused on software development, algorithms, and emerging technologies.",
    },
  ];
  ...
  const experience = [
    {
      ...
      period: "Summer 2024",
      location: "Remote",
      description: "Developed web applications using React, Node.js, and modern development practices.",
      achievements: ["Built responsive web applications", "Collaborated with cross-functional teams", "Learned industry best practices"],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
            I'm a passionate frontend developer with a keen interest in Web3 technologies, 
            always eager to learn and build innovative solutions that push the boundaries of web development.
          </p>
        </motion.div>
          ...
          >
            <div className="bg-white/10 dark:bg-black/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 dark:border-white/10">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                As a Computer Science Engineering student with a passion for frontend development, 
                I love creating beautiful, functional, and user-friendly web applications. 
                My journey in tech has been driven by curiosity and a desire to solve real-world problems through code.
              </p>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                When I'm not coding, you can find me exploring the latest Web3 trends, 
            ...
            <div className="bg-white/10 dark:bg-black/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 dark:border-white/10">
              ...
              {education.map((edu, index) => (
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-3 leading-relaxed">{edu.description}</p>
                </motion.div>
              ))}
            </div>
